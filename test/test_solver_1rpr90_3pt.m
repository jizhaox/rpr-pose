%% test solvers for 1RPR90+3pt method
...
% [R_sols, t_sols, cay_sols] = solver_1rpr90_3pt(data);
% INPUT
% data: RPR90 and point observations of two views
%     size is 28*1
%     order is: RPR90 #1, point #1, point #2, point #3 at view 1, 
%               RPR90 #1, point #1, point #2, point #3 at view 2.
...
clear;
disp('================== 1RPR90 + 3pt method ==================');
%% prepare data
[data, R_gt, cay_gt, t_gt] = generate_1rpr90_3pt_synthetic();

%% run the solver
tic, [R_sols, t_sols] = solver_1rpr90_3pt(data); toc
R_sols, R_gt
t_sols, t_gt
